...
class Property(models.Model):
    """Main property model."""
    name = models.CharField(max_length=200, unique=True, default='Unnamed Property')
    short_name = models.CharField(max_length=100, unique=True, default='unnamed-property')
    ...
    booking_com_name = models.CharField(max_length=200, blank=True, null=True)
    airbnb_name = models.CharField(max_length=200, blank=True, null=True)
...
class Spec(models.Model):
    ...
    def __str__(self):
        return f"{self.property.name} - Specs"
...
class SEFDetail(models.Model):
    ...
    def __str__(self):
        return f"{self.property.name} - SEF"